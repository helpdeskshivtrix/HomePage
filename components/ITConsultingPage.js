function ITConsultingPage() {
  try {
    const services = [
      { icon: 'lightbulb', title: 'Technology Roadmap Development', desc: 'Strategic IT planning and direction' },
      { icon: 'cpu', title: 'Digital Transformation Strategy', desc: 'Modernize your business operations' },
      { icon: 'layers', title: 'IT Governance & Standards Compliance', desc: 'ISO certified infrastructure design' },
      { icon: 'target', title: 'Future-Ready & Scalable Solution', desc: 'Latest Industry-standard implementations' }
    ];

    return (
      <div className="min-h-screen bg-[var(--primary-color)] relative" data-name="it-consulting-page" data-file="components/ITConsultingPage.js">
        {/* Hero Section */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center">
              ...
              <p className="text-xl text-[var(--secondary-color)] max-w-3xl mx-auto slide-up">
                Strategic technology planning and consulting to drive your business forward
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="bg-[var(--tertiary-color)]/70 backdrop-blur-md border border-[var(--accent-color)]/50 rounded-2xl p-12">
              <h2 className="text-3xl font-bold text-white mb-6">Transform Your IT Strategy</h2>
              <button 
    ...
    console.error('ITConsultingPage component error:', error);
    return null;
  }
}